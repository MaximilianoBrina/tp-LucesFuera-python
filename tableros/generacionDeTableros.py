import itertools
import tableros.validacionDeFuncionLectoraDeArchivo
...
def lucesNivelPredeterminado():
    ...
    with open("tableros/archivoDeTableros.txt") as archivoDeTableros:
        lucesDeTablerosModoPredeterminado = []
        for nivel in archivoDeTableros:
            nivel = nivel.rstrip("\n")
            lucesDeTablerosModoPredeterminado.append(nivel)
            tableros.validacionDeFuncionLectoraDeArchivo.validacionDeFuncionLectoraDeArchivo(lucesDeTablerosModoPredeterminado)
        #meter aca funcion para validar tableros predeterminados extaidos de txt.
        """
        #funcion validacion de tableros predeterminados de txt
        extensionesDeListas=[]
        for lista in lucesDeTablerosModoPredeterminado:#validacion de que todo esta bien con el tablero
            extensionLista = len(lucesDeTablerosModoPredeterminado[lista])
            extensionesDeListas.append(extensionLista)
            #comprobar que todos los elementos son iguales
        """
